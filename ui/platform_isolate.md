...
The [computation] and any state it captures may be sent to that isolate. See [SendPort.send] for information about what types can be sent.
...
If [computation] throws, the `Future` returned by this function completes with that error.
