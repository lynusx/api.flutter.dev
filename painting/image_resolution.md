...
heart.png 2.0x/heart.png 4.0x/heart.png
...
icons/heart.png icons/1.5x/heart.png icons/2.0x/heart.png
...
The following shows the code required to write a widget that fully conforms to the [AssetImage] and [Widget] protocols. (It is essentially a bare-bones version of the [Image] widget made to work specifically for an [AssetImage].)
