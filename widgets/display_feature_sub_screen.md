...
{@template flutter.widgets.DisplayFeatureSubScreen.anchorPoint} The anchor point used to pick the closest sub-screen.
...
- for [TextDirection.rtl], [anchorPoint] is `Offset(double.maxFinite, 0)`, which will cause the top-right sub-screen to be picked. {@endtemplate}
