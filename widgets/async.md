...
** See code in examples/api/lib/widgets/async/stream_builder.0.dart ** {@end-tool}

See also:

- [ValueListenableBuilder], which wraps a [ValueListenable] instead of a [Stream].
- [StreamBuilderBase], which supports widget building based on a computation that spans all interactions made with the stream.
...
** See code in examples/api/lib/widgets/async/future_builder.0.dart ** {@end-tool}
