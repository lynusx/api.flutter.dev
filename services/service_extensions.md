@docImport 'binding.dart'; @docImport 'debug.dart';
...
- [debugProfilePlatformChannels], which is the flag that this service extension exposes.
- [ServicesBinding.initServiceExtensions], where the service extension is registered.
